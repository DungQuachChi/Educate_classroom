import 'package:educate_classroom/screens/instructor/new_instructor_message_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ConversationModel>>(
        stream: messageProvider.getConversationsStream(currentUserId, true),
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const NewInstructorMessageScreen(),
            ),
          );
        },
